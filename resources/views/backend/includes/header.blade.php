<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{ asset('img/ppcoin-navbar-logo-inverted.png') }}" width="89" height="25" alt="PPCoin">
        <img class="navbar-brand-minimized" src="{{ asset('iimg/ppcoin-navbar-logo-inverted.png') }}" width="30" height="30" alt="PPCoin">
    </a>
