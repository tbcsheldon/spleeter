...
.method constructor <init>(Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->a(Ljava/lang/Class;)Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$a;
...
.method private static b(Ljava/lang/Class;)Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$a;
    ...
    invoke-static {v6}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->a(Ljava/lang/Class;)Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$a;
    ...
    check-cast v7, Landroid/arch/lifecycle/b$a;

    invoke-static {v1, v8, v7, p0}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->a(Ljava/util/Map;Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/b$a;Ljava/lang/Class;)V
    ...
    const-class v6, Landroid/arch/lifecycle/d;

    invoke-virtual {v5, v6}, Ljava/lang/reflect/Method;->getAnnotation(Ljava/lang/Class;)Ljava/lang/annotation/Annotation;

    move-result-object v6

    check-cast v6, Landroid/arch/lifecycle/d;
    ...
    :goto_3
    invoke-interface {v6}, Landroid/arch/lifecycle/d;->a()Landroid/arch/lifecycle/b$a;
    ...
    const-class v9, Landroid/arch/lifecycle/b$a;
    ...
    :cond_6
    sget-object v8, Landroid/arch/lifecycle/b$a;->ON_ANY:Landroid/arch/lifecycle/b$a;
    ...
    invoke-static {v1, v7, v6, p0}, Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver;->a(Ljava/util/Map;Landroid/arch/lifecycle/ReflectiveGenericLifecycleObserver$b;Landroid/arch/lifecycle/b$a;Ljava/lang/Class;)V
